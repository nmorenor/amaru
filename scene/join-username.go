...
func NewJoinUserNameMenu(screenWidth int, screenHeight int, session *component.SessionData) *JoinUserNameMenu {
	menu := &JoinUserNameMenu{
		screenWidth:  screenWidth,
		screenHeight: screenHeight,
		offscreen:    ebiten.NewImage(screenWidth, screenHeight),
		uiHandler:    ui.NewTextInputMenu("Your Name:", "Continue", "Cancel", "Name"),
	}
...
func (menu *JoinUserNameMenu) loadMenu(session *component.SessionData) {
...
func (menu *JoinUserNameMenu) UpdateLayout(width, height int) {
	// do nothing
}

func (menu *JoinUserNameMenu) createWorld(levelIndex int) donburi.World {
...
func (menu *JoinUserNameMenu) renderUI(image *ebiten.Image) *ebiten.Image {
	menu.uiHandler.Draw(image)
	return image
}

func (menu *JoinUserNameMenu) NextScene() archetype.Scene {
	if menu.uiHandler.Done {
		...
		return NewJoinSessionMenu(menu.game.Settings.ScreenWidth, menu.game.Settings.ScreenHeight, menu.game.Session, menu.game)
	}
...
func (menu *JoinUserNameMenu) Update() {
	archetype.PlayAudioMenu()
...
func (menu *JoinUserNameMenu) Draw(screen *ebiten.Image) {
	screen.Clear()
